...
class _ExpresateScreenState extends State<ExpresateScreen> {
  ...
  Future<void> generarYLeerFrase() async {
    ...
    final prompt =
        "Genera una frase corta, coherente y natural en español como si fuera dicha por un niño, usando estos pictogramas: ${seleccionados.map((p) => p.nombre).join(', ')}. "
        "Si detectas un lugar como 'baño', di 'quiero ir al baño'. "
        "Si detectas 'agua', di 'quiero agua'. "
        "Si hay una actividad como 'baloncesto' o 'estudiar', di 'quiero jugar baloncesto' o 'tengo que estudiar'. Usa expresiones típicas de niños.";
